...
const newblog=await api.post('/api/blogs').set('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IjExMTEiLCJpZCI6IjVlZWFjMThkZmM3MDUzNzAwMGRkMjc4NCIsImlhdCI6MTU5MjQ0Mzk4NH0.D4TJ502z-eudWntUaPKneg3kaoS6iSfc2CVZdl7OcRs').send({title: 'g',author: "b",url: "f",likes: 0}).expect(201)
...
await api.delete('/api/blogs')
const newblog=await api.post('/api/blogs').set('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IjExMTEiLCJpZCI6IjVlZWFjMThkZmM3MDUzNzAwMGRkMjc4NCIsImlhdCI6MTU5MjQ0Mzk4NH0.D4TJ502z-eudWntUaPKneg3kaoS6iSfc2CVZdl7OcRs').send({title: 'a',author: "s",url: "x",likes: 0})
...
const newblog=await api.post('/api/blogs').set('Authorization', 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6IjExMTEiLCJpZCI6IjVlZWFjMThkZmM3MDUzNzAwMGRkMjc4NCIsImlhdCI6MTU5MjQ0Mzk4NH0.D4TJ502z-eudWntUaPKneg3kaoS6iSfc2CVZdl7OcRs').send(ablog)//.expect(201)
